    ...
    highlight_overrides = {
      all = function(colors)
        return {
          ...
          TSTitle = { link = "Title" },
          TSTodo = { link = "Todo" },
          TSType = { fg = colors.mauve, style = { "bold" } },
          TSTypeBuiltin = { fg = colors.mauve, style = { "bold" } },
          TSTypeDefinition = { fg = colors.mauve, style = { "bold" } },
          TSTypeQualifier = { fg = colors.mauve, style = { "bold" } },
